...
public class TodayClassDTO {
    ...
    public boolean getIsUnlockedByAdmin() {
        return isUnlockedByAdmin;
    }

    public void setIsUnlockedByAdmin(boolean isUnlockedByAdmin) {
        this.isUnlockedByAdmin = isUnlockedByAdmin;
    }
